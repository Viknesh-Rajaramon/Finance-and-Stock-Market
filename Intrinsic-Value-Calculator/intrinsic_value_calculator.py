...
if __name__ == "__main__":
    tickers = ["AMBUJACEM", "ASIANPAINT", "BRITANNIA", "BSE", "CDSL", "COLPAL", "CROMPTON", "DABUR", "EICHERMOT", "HAVELLS", "HCLTECH", "HDFCBANK", "HEROMOTOCO", "HINDUNILVR", "INFY", "IRCTC", "KOTAKBANK", "PIDILITIND", "RAMCOCEM", "RELIANCE", "SBICARD", "STARHEALTH", "SUNTV", "TCS", "TVSMOTOR"]
    for t in tickers:
        ticker = t + ".NS"
